...
router.get('/api/v1/lists/:listId', (request, response) => {
...
router.post('/api/v1/lists', (request, response) => {
...
router.delete('/api/v1/lists/:listId', (request, response) => {
    const listId = request.params.listId;
...
router.get('/api/v1/lists/:listId/tasks', (request, response) => {
    const listId = request.params.listId;
    const index = lists.findIndex(l => l.listId == listId);
...
router.get('/api/v1/lists/:listId/tasks/:taskId', (request, response) => {
    const listId = request.params.listId;
...
router.post('/api/v1/lists/:listId/tasks', (request, response) => {
    const listId = request.params.listId;
...
router.delete('/api/v1/lists/:listId/tasks/:taskId', (request, response) => {
    const listId = request.params.listId;
    const taskId = request.params.taskId;
